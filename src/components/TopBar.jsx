...
export const TopBar = () => {
    ...
    return (
        ...
        <div className='topbar w-full flex items-center justify-between py-3 md:py-5 px-4 rounded-lg bg-primary'>
            ...
            <div className='flex w-[22%] justify-between items-center text-ascent-1 text-md md:text-2xl mr-6'>
                ...
                <div>
                    <CustomBtn onClick={() => dispatch(Logout())} title='Log Out' containerStyles='text-sm text-ascent-1 px-4 md:px-6 py-1 md:py-2 border rounded-full transition duration-300  hover:shadow-lg hover:shadow-shadowcolor hover:bg-hovercolor' />
                </div>
