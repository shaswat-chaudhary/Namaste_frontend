...
export const TopBar = () => {
    ...
    return (
        ...
        <div className='sticky z-50 top-0 w-full h-12 md:h-24 flex items-center justify-between py-3 md:py-5 px-4 md:rounded-lg bg-primary border-b text-ascent-2'>
